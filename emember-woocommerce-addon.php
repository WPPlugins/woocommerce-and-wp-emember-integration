            ...
            if (!empty($level_id)) {
                ...
                if(is_object($user) && !empty($user->ID)){
                    ...
                    if (!$user_exists) {
                        ...
                        //The standard signup handling code will take care of it.
                        eMember_log_debug("There is an eMember entry for this user. So the standard signup handling function will tackle it.", true);
                    }
                }
                
                //Handle the signup using standard process
