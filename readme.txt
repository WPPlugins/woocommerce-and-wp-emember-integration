...
The membership side of things is managed by [WP eMember plugin](http://www.tipsandtricks-hq.com/wordpress-emember-easy-to-use-wordpress-membership-plugin-1706).
...
View the full [usage instruction here](http://www.tipsandtricks-hq.com/wordpress-membership/woocommerce-wp-emember-integration-1013)
